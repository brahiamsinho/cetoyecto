...
class StorePostulanteRequest extends FormRequest
{
    ...
    {
        return [
            'ci' => ['required', 'string', 'unique:postulantes,ci', 'regex:/^[0-9]+$/'],
            ...
            'tiene_carnet_identidad' => ['required', 'boolean'],
            'tiene_foto' => ['required', 'boolean'],
            'tiene_diploma_bachiller' => ['required', 'boolean'],
        ];
    }
    ...
    public function messages(): array
    {
        return [
            ...
            'tiene_carnet_identidad.required' => 'Debe confirmar que tiene el carnet de identidad.',
            'tiene_foto.required' => 'Debe confirmar que tiene la foto.',
            'tiene_diploma_bachiller.required' => 'Debe confirmar que tiene el diploma de bachiller.',
        ];
    }
}
